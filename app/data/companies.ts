...
export const companies: Record<string, CompanyInfo> = {
  'Primer AI, Inc | San Francisco, CA, USA': {
    id: 'descartes',
    logoUrl: '/icons/Primer_Logo.jpg',
    fallbackLogoUrl: faviconUrl('primer.ai'),
    badge: 'DE',
    websiteUrl: 'https://primer.ai/',
  },
  'Wispr Flow | San Francisco, CA, USA': {
    id: 'descartes',
    logoUrl: '/icons/Wispr_Flow_Logo.jpg',
    fallbackLogoUrl: faviconUrl('wisprflow.ai'),
    badge: 'DE',
    websiteUrl: 'https://wisprflow.ai/',
  },
  'Vietnam AI Research Lab | Ho Chi Minh city, Vietnam': {
    id: 'descartes',
    logoUrl: '/icons/defaultThumbnail-MWgjN-_C.jpg',
    fallbackLogoUrl: faviconUrl('aiotlab.vn'),
    badge: 'DE',
    websiteUrl: 'https://aiotlab.vn',
  },
